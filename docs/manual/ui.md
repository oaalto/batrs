...
- After login, **Up** and **Down** recall prior commands you typed.
- Select and copy game text with your terminal’s normal drag-select (right-click for the context menu works too).
