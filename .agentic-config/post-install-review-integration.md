...
- - **What you may edit directly:** agent setup the bundle added — merge/splice `AGENTS.md`, adjust `.cursor/rules/`, `.agents/rules/`, fix `.agents/skills/` layout; and **initial wiki bootstrap** when creating new wiki pages from verified repo sources.
