...
impl AelenaGuild {
    ...
    pub fn cast_sting_of_aelena(
        ...
        command::send(cast_spell("sting of aelena", data))
    }
    ...
    pub fn cast_bite_of_the_black_widow(
        ...
        command::send(cast_spell("bite of the black widow", data))
    }
    ...
    pub fn use_wound(
        ...
        command::send(use_skill("wound", data))
    }
    ...
    pub fn use_thrust(
        ...
        command::send(use_skill("thrust", data))
    }
    ...
    pub fn use_dissection(
        ...
        if parts.len() < 2 {
            return vec![command::output(StyledLine::new(
    ...
    pub fn familiar_store_slow_death(
        ...
        command::send(abilities::client_send_line("familiar store slow death"))
    }
    ...
    pub fn familiar_store_rusted_blade(
        ...
        command::send(abilities::client_send_line("familiar store rusted blade"))
    }
    ...
    pub fn familiar_store_black_trance(
        ...
        command::send(abilities::client_send_line("familiar store black trance"))
    }
    ...
    pub fn rip_dissect(
        ...
        command::send("@rip_action set get all from corpse;drop zinc;drop mowgles".to_string())
    }
    ...
    pub fn rip_harvest_spleen(
        ...
        command::send("@rip_action set get all from corpse;familiar harvest spleen any;drop zinc;drop mowgles".to_string())
    }
...
mod tests {
    ...
    fn sting_without_target() {
        let result = AelenaGuild::cast_sting_of_aelena(&data("csa", ""), &empty_ctx());
        assert_eq!(result, command::send("@cast 'sting of aelena'".to_string()));
    }

    #[test]
    fn sting_with_target() {
        let result = AelenaGuild::cast_sting_of_aelena(&data("csa", "orc"), &empty_ctx());
        assert_eq!(
            result,
            command::send("@target orc;cast 'sting of aelena' orc".to_string())
        );
    }

    #[test]
    fn slow_death_combo() {
        let result = AelenaGuild::cast_slow_death_combo(&data("csd", "troll"), &empty_ctx());
        assert_eq!(
            result,
            command::send(
                "@aelena poison slow death;target troll;cast 'sting of aelena' troll".to_string()
            )
        );
    }
    ...
    fn black_trance_defaults_sting_to_me() {
        let result = AelenaGuild::cast_black_trance_combo(&data("cbt", ""), &empty_ctx());
        assert_eq!(
            result,
            command::send(
                "@aelena poison black trance;target me;cast 'sting of aelena' me".to_string()
            )
        );
    }
    ...
    fn dissection_requires_two_args() {
        let result = AelenaGuild::use_dissection(&data("ud", "onlyone"), &empty_ctx());
        assert_eq!(
            result,
    ...
    fn harvest_spleen_rip_line() {
        let result = AelenaGuild::rip_harvest_spleen(&data("rip_spleen", ""), &empty_ctx());
        assert_eq!(
            result,
            command::send(
