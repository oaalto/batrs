...
- **Track follow-up for temporary suppressions:** When a suppression is temporary, include a tracking reference or clear follow-up note.

## Review Expectations

- Warning/lint suppressions should be easy to justify and verify at review time.
- New broad suppressions should be treated as design debt and rejected unless explicitly approved.
